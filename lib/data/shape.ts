  ...
  return [
    {
      ...
      role: 'ADVANCED ANTI-AGING & AESTHETICS SPECIALIST',
      highlight: '',
    ...
    },
    {
      id: 'rebecca',
      name: 'Rebecca Spacek',
      role: 'AESTHETICIAN & LASER PRACTITIONER',
      highlight: '',
    ...
    {
      id: 'marla',
      name: 'Marla Jackson, MSN, FNP-C',
      role: 'NURSE PRACTITIONER',
      highlight: '',
      image: '/images/team-12-img.png',
      imageAlt: 'Marla Jackson, MSN, FNP-C',
      sortOrder: 3,
      isActive: true,
      bio: `Marla Jackson is a Family Nurse Practitioner with a deep dedication to patient care, aesthetic medicine, and wellness. She combines clinical precision with an artistic eye to help patients look and feel refreshed.\n\nWith extensive background in clinical patient care, Marla excels at understanding individual patient goals and designing comprehensive aesthetic treatments. Her warm, empathetic approach ensures that every patient feels comfortable, heard, and supported throughout their aesthetic journey.\n\nShe specializes in customized cosmetic injectables, skin rejuvenation protocols, and wellness consultations, focusing on natural-looking enhancements that boost self-confidence and restore youthful radiance.\n\nMarla earned her Bachelor of Science in Nursing from Georgia Southern University and her Master of Science in Nursing from South University in Savannah, Georgia.\n\nWhen she is not caring for patients, Marla enjoys spending time with her family, traveling, and exploring the low country.`,
    },
    {
      id: 'sara',
      name: 'Sarah Mallow, MSN, WHNP',
      role: 'ADVANCED AESTHETICS SPECIALIST',
      highlight: '',
      image: '/images/photo-content-10-img.jpg',
      imageAlt: 'Sarah Mallow, MSN, WHNP',
      sortOrder: 4,
      isActive: true,
      bio: `Sarah Mallow is an Advanced Practice Registered Nurse specializing in aesthetic medicine and women's health. She is passionate about empowering patients through personalized, science-backed treatments.\n\nBringing years of clinical excellence to Savannah Skin and Med Spa, Sarah emphasizes patient safety, comfort, and natural aesthetic outcomes. She takes the time to educate her clients, ensuring they understand their treatment options and feel confident in their skincare decisions.\n\nSarah is skilled in advanced injectable techniques, dermal fillers, collagen-stimulating therapies, and customized skin revitalization programs designed to harmonize and enhance facial aesthetics.\n\nSarah earned her Bachelor of Science in Nursing from Georgia Southern University and her Master of Science in Nursing from the University of South Alabama.\n\nOutside of the clinic, Sarah enjoys spending quality time with her husband and daughters, reading, and enjoying coastal Georgia.`,
    },
  ];
}
