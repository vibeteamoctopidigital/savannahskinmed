...
export default function PageHero({
  ...
  return (
    <section className="relative flex min-h-[500px] sm:min-h-[500px] sm:h-[88vh] sm:max-h-[700px] items-center justify-center overflow-hidden">
      <Image
        src={imageSrc}
        alt={imageAlt}
        fill
      ...
      <div className="relative z-10 mx-auto w-full max-w-[900px] px-6 pt-16 text-center sm:pt-32">
