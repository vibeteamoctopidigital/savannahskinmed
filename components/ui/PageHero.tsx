...
export default function PageHero({
  ...
  return (
    <section className="relative flex min-h-[520px] max-h-[640px] items-center justify-center overflow-hidden sm:h-[88vh] sm:min-h-[500px] sm:max-h-[760px]">
      <Image
        src={image}
        alt={imageAlt}
        fill
      ...
      <div className="relative z-10 mx-auto w-full max-w-[900px] px-5 pt-28 text-center sm:pt-32">
