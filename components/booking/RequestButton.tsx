  ...
  return (
    <>
      <button
        ...
        className={`group inline-flex items-center w-full max-w-[305px] sm:w-[305px] min-h-[50px] justify-center gap-3 rounded-full  py-[15px] font-bold font-sans text-[14px] uppercase tracking-widest2 transition-colors duration-300 ${variants[variant]} ${className}`}
      >
      ...
      <BookingModal title='Request Details' open={open} onClose={() => setOpen(false)} />
    </>
  );
}